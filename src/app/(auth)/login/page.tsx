...
export default function LoginPage() {
  const { loading, error, signIn, signInWithGoogle, clearError } = useAuth()
  ...
  return (
    <div className="rounded-card bg-parchment border border-sandstone shadow-sacred p-8 space-y-6">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="font-devanagari text-twilight text-base">साधना में आपका स्वागत है</p>
      </div>
      ...
      <p className="text-center text-sm text-twilight">
        New to SadhanaOS?{' '}
        <Link href="/signup" className="text-sacred-saffron hover:text-saffron-deep font-medium transition-colors">
          Begin your sadhana
        </Link>
      </p>
    </div>
